...
const ListOfProductsWithCombinations = (props) => {
  return (
    <div className='w-full mt-6 bg-white border border-t-[#78c4d8] border-t-[2px]'>
    <div className='p-[24px]'>
        <h2 className='text-[24px] font-semibold text-[#363a41]'>List of products with combinations but without available quantities for sale (0)</h2>
    </div>
    <div className='p-[24px]'>
        <div>
            <div className=' px-[4]'>
...
export default ListOfProductsWithCombinations