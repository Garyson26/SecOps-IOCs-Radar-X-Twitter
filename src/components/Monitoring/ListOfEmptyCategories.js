...
const ListOfEmptyCategories = (props) => {
  return (
    <div className='w-full mt-6 bg-white border border-t-[#78c4d8] border-t-[2px]'>
                <div className='p-[24px]'>
                    <h2 className='text-[24px] font-semibold text-[#363a41]'>List of empty categories (0)</h2>
                </div>
                <div className='p-[24px]'>

                    <div className='bg-[#e8edfd] flex items-center p-[16px]'>
                        <AiFillInfoCircle className='text-[#174eef] text-[22px]' />
                        <p className='text-[14px] pl-3 text-[#363a41]'>
...
export default ListOfEmptyCategories