...
import CustomerAccountsChart from '../Common/CustomerAccountsChart'
const CustomerAccounts = () => {
    return (
        <div>
            <TableDataFilter />
            <div className='border-t mt-4  bg-white border  p-6 border-t-[#78c4d8]'>
                <h3 className='text-[24px] leading-5 font-semibold mb-10 text-ellipsis'>Customer accounts</h3>


                <div className='grid gap-8 lg:grid-cols-12'>
                    <div className='lg:col-span-8'>
                        <CustomerAccountsChart />
                    </div>
