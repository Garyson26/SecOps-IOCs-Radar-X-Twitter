    ...
    return (
        <div>
            ...
            <div className='border-t mt-4 bg-white border  p-6 border-t-[#78c4d8]'>
                <h3 className='text-[24px] leading-5 font-semibold text-ellipsis'>Best-selling products</h3>
                ...
                <div className='overflow-auto mt-5 px-[4]'>
                    <table className="min-w-full  divide-y divide-gray-300">
                        ...
                        <tbody className="divide-y divide-gray-200">
                            {
                                orderdetail.length >= 0 ?
                                    <tr><td className="text-[#363a41] text-center p-2 text-[12px] " colspan="9">Empty</td></tr>
                                    :
                                    <>
                                        {orderdetail.map((item, index) => (
                                            <tr key={index} className='even:bg-gray-50'>
                                                ...
                                                <td className="text-[#363a41] text-center p-2 text-[12px]">{item.quan}</td>
                        ...
                        <tfoot><tr><th colspan="9" className="text-[#363a41] text-left p-2 text-[12px] ">Displaying 0 - 0 of 0</th></tr></tfoot>
                    </table>
