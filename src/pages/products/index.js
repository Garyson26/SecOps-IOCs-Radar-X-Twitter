...
const Products = () => {
    ...
    return (
        ...
        <div className='bg-white flex items-center justify-between px-4 py-5 sm:px-6  lg:px-8 border-b '>
            ...
            <div>
                <Link href="/products/create" className=' flex items-center bg-black text-white gap-1.5 px-3 py-1.5'>
                
                  <FiPlusCircle />  New Product
                </Link>
            </div>
        </div>
        ...
        <div className='border-t  bg-white border p-6 border-t-[#78c4d8]'>
            <h2 className='text-[24px] text-[#363a41] font-semibold'>Products (5)</h2>
