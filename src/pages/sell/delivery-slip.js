...
const DeliverySlip = () => {
  return (
    ...
    <div className="bg-white flex items-center justify-between px-4 py-5 sm:px-6  lg:px-8 border-b ">
        <h1 className="text-[24px] font-semibold ">Delivery Slip</h1>
                    ...
                    <tbody className="divide-y divide-gray-200">
                        {orderdetail.map((item, index) => (
                            <tr key={index}>
                                ...
                                <td className="text-[#363a41] px-3 py-4 text-[13px] text-center">
                                    {item.NumofProducts}
                                </td>
                                <td className="text-[#363a41] px-3 py-4 text-[13px] ">
                                    {item.Customer}
                                ...
                                <div className="flex items-center">
                                    <Link href={'/invoice'} className="px-1" title="Download Invoice">
                                        <HiOutlineDownload />
                                    </Link>
                                    <button className="px-1" title="Delete">
                                        <MdDeleteForever />
                                    </button>
                                    </div>
                                </td>
