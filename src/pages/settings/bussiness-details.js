    ...
    <div>
      <div className="bg-white">
        ...
        <div className="border-b flex items-center">
          <Link
            className="p-[15px_20px] border-b-2 border-transparent cursor-pointer block"
            href="/settings/profile"
          >
            Profile
          </Link>
          <Link
            className="p-[15px_20px] border-b-[3px] bg-[#f7fcfd] border-black cursor-pointer block"
          ...
          <div className="relative flex flex-col min-w-0 break-words w-full mb-6 shadow-lg rounded-lg bg-blueGray-100 border-0">
            <div className="rounded-t bg-white mb-0 px-6 py-6">
              <div className="text-center flex justify-between">
                <h6 className="text-blueGray-700 text-xl font-bold">Bussiness Details</h6>
              </div>
            </div>
