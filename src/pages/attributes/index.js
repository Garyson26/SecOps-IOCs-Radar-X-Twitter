            ...
            <div className='bg-white'>
                <div className=' flex items-center justify-between px-4 py-5 sm:px-6  lg:px-[15px] border-b '>
                    ...
                    <div className='flex items-center gap-2'>
                        <Link href="/attributes/addnewattribute" className=' flex items-center border text-[14px] font-medium border-black text-black bg-white gap-1.5 px-3 py-1.5'>

                            <AiFillPlusCircle className='text-[16px]' />  Add new attribute
                        </Link>
                        <Link href="/attributes/addnewvalue" className=' flex items-center border text-[14px] font-medium border-black text-black bg-white gap-1.5 px-3 py-1.5'>

                            <AiFillPlusCircle className='text-[16px]' />  Add new value
                        </Link>
