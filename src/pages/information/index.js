...
const Information = () => {
  return (
    ...
    <div data-custom-class="body" className="bg-white max-w-7xl mx-auto py-12 ">
            ...
            >
              ...
              >
                ...
                <span style={{ fontSize: 15 }}>
                      ...
                      <span data-custom-class="body_text">
                        <span style={{ color: "rgb(89, 89, 89)" }}>
                          <span style={{ fontSize: 15 }}>
                            ...
                            at <bdt className="question">12,Dastesxas </bdt>
                            <bdt className="block-component" />
                          </span>
                        </span>
                      ...
                      <span data-custom-class="body_text">
                        <span style={{ fontSize: 15 }}>
                          <span data-custom-class="body_text">
                            <span style={{ color: "rgb(89, 89, 89)" }}>
                              <bdt className="block-component" />,{" "}
                              <bdt className="question">erd</bdt>
                              <bdt className="statement-end-if-in-editor" />
                              <bdt className="block-component" />{" "}
                              <bdt className="question">204325</bdt>
                              <bdt className="statement-end-if-in-editor" />
                            </span>
                          </span>
                        </span>
                  ...
                  <bdt className="question">GB999999999.</bdt>
                  <bdt className="statement-end-if-in-editor" />
                </span>
              </span>
            </span>
    ...
    <div align="center" style={{ textAlign: "left" }}>
      ...
      >
        ...
        >
          ...
          phone at <bdt className="question">18005555555</bdt>, email at{" "}
          <bdt className="question">demo@gail.com</bdt>
          <bdt className="block-component" />,
          <bdt className="statement-end-if-in-editor" /> or by mail to{" "}
          <bdt className="question">12,Dastesxas </bdt>
          <bdt className="block-component" />,{" "}
          <bdt className="question">texas</bdt>
          <bdt className="block-component" />, <bdt className="question">erd</bdt>
          <bdt className="statement-end-if-in-editor" />
          <bdt className="block-component" />{" "}
          <bdt className="question">204325</bdt>
          <bdt className="statement-end-if-in-editor" />
          <bdt className="block-component">,&nbsp;</bdt>
          <bdt className="question">Falkland Islands</bdt>
          <bdt className="statement-end-if-in-editor" />.
        </span>
      </div>
      <div className="MsoNormal" style={{ lineHeight: 1 }}>
      ...
      >
        ...
        >
          ...
          <bdt className="statement-end-if-in-editor" />
          ), and <bdt className="question">demo</bdt>, concerning your access to
      ...
      >
        ...
        >
          ...
          <bdt className="question">info@gmail.com</bdt>, as stated in the email
    ...
    <div align="center" style={{ textAlign: "left" }}>
      ...
      >
        ...
        >
          ...
          address your request to: <bdt className="question">demo@gail.com</bdt>.
      ...
      >
        ...
        >
          ...
          <span style={{ fontSize: 15 }}>
            ...
            specifications, and details of the products available on the Services.
            However, we do not guarantee that the{" "}
            <bdt className="block-component" />
            colors
            <bdt className="statement-end-if-in-editor" />, features,
    ...
    <div align="center" style={{ textAlign: "left" }}>
      ...
      >
        ...
        >
          ...
          <bdt className="block-component" />
          authorize
          <bdt className="statement-end-if-in-editor" /> us to charge your chosen
                    ...
                    >
                      ...
                      >
                        ...
                        >
                          ...
                          unauthorized
                          <bdt className="statement-end-if-in-editor" /> script or
                          other software.
                        </span>
                      </span>
                    </span>
            ...
            <bdt data-type="body">
              ...
              >
                ...
                >
                  ...
                  <bdt className="block-component" />
                  re-categorize
                  <bdt className="statement-end-if-in-editor" /> any Contributions
    ...
    >
      ...
      >
        ...
        <bdt className="forloop-component" />
        <bdt className="block-component" />
        <bdt className="block-component" />, <bdt className="question">India</bdt>
        <bdt className="statement-end-if-in-editor" />
        <bdt className="statement-end-if-in-editor" />
        <bdt className="forloop-component" />
        <bdt className="block-component" />
        ...
        <bdt className="statement-end-if-in-editor" />
        <bdt className="forloop-component" />
        <bdt className="statement-end-if-in-editor" />. If you access the Services
        ...
        <bdt className="statement-end-if-in-editor" />
        <bdt className="forloop-component" />
        <bdt className="statement-end-if-in-editor" />, then through your
        ...
        <bdt className="forloop-component" />
        <bdt className="block-component" /> <bdt className="block-component" />{" "}
        and <bdt className="question">United Kingdom</bdt>
        <bdt className="statement-end-if-in-editor" />
        <bdt className="forloop-component" />
        <bdt className="statement-end-if-in-editor" />, and you expressly consent
    ...
    >
      ...
      >
        ...
        <bdt className="question">Bermuda</bdt>
        <bdt className="else-block" />
      </span>
      ...
      country to residence. <bdt className="question">demo</bdt> and yourself both
      agree to submit to the non-exclusive jurisdiction of the courts of{" "}
      <bdt className="question">__________</bdt>, which means that you may make a
      claim to defend your consumer protection rights in regards to these Legal
      Terms in <bdt className="block-component" />
      <bdt className="question">Bermuda</bdt>
      <bdt className="else-block" />, or in the EU country in which you reside.
      <bdt className="else-block" />
    </div>
    <div className="MsoNormal" style={{ lineHeight: "1.5", textAlign: "left" }}>
      <br />
    ...
    >
      <span style={{ fontSize: 15 }}>
        ...
        <bdt className="question">seven (7)</bdt> days before initiating
    ...
    >
      ...
      <span style={{ fontSize: 15 }}>
        ...
        AAA Consumer Rules. <bdt className="block-component" />
        ...
        <bdt className="block-component" />
        the <bdt className="question">U.S. Armed Forces - Americas</bdt>
        <bdt className="else-block" />. Except as otherwise provided herein, the
        ...
        <bdt className="block-component" />
        judgment
        <bdt className="statement-end-if-in-editor" /> on the award entered by the
        arbitrator.
      </span>
    </div>
    <div className="MsoNormal" style={{ lineHeight: "1.5", textAlign: "left" }}>
    ...
    >
      ...
      <span style={{ fontSize: 15 }}>
        ...
        <bdt className="statement-end-if-in-editor" />. Application of the United
    ...
    >
      ...
      utilize
      <bdt className="statement-end-if-in-editor" /> class action procedures; and
    ...
    >
      ...
      >
        ...
        <bdt className="block-component" />
        JUDGMENT
        <bdt className="statement-end-if-in-editor" /> AND EXERCISE CAUTION WHERE
        APPROPRIATE.
      </span>
    </div>
    <div className="MsoNormal" style={{ lineHeight: "1.5", textAlign: "left" }}>
    ...
    >
      ...
      >
        ...
        defense
        <bdt className="statement-end-if-in-editor" /> of such claims. We will use
    ...
    >
      <strong>
        ...
        >
          <strong>
            <bdt className="block-component" />
            Phone: <bdt className="question">18005555555</bdt>
            <bdt className="statement-end-if-in-editor" />
          </strong>
        </span>
      </strong>
    ...
    >
      ...
      <strong>
        ...
        >
          <strong>
            Fax: <bdt className="question">18005555555</bdt>
            <span
              style={{
                fontSize: "11.0pt",
                lineHeight: "115%",
