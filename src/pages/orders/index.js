            ...
            <div className="grid grid-cols-1 gap-3 sm:grid-cols-2 lg:grid-cols-4">
                <div className="border px-4 py-3 font-ibm bg-white">
                    <div className="flex items-center gap-2">
                        ...
                        <div>
                            <span className="text-[14px] text-[#363a41]">Conversion Rate</span>
                            <div className="flex gap-3 items-center">
                                <span className="text-[#1d1d1b] text-[14px]">0%</span>
                                <span className="text-[12px] text-[#6c868e]">30 DAYS</span>
                            </div>
                        </div>
                    </div>
                </div>
                <div className="border px-4 py-3 font-ibm bg-white">
                    <div className="flex items-center gap-2">
                        ...
                        <div>
                            <span className="text-[14px] text-[#363a41]">Abandoned Carts</span>
                            <div className="flex gap-3 items-center">
                                <span className="text-[#1d1d1b] text-[14px]">0</span>
                                <span className="text-[12px] text-[#6c868e]">TODAY</span>
                            </div>
                        </div>
                    </div>
                </div>
                <div className="border px-4 py-3 font-ibm bg-white">
                    <div className="flex items-center gap-2">
                        ...
                        <div>
                            <span className="text-[14px] text-[#363a41]">Average Order Value</span>
                            <div className="flex gap-3 items-center">
                                <span className="text-[#1d1d1b] text-[14px]">€0.00</span>
                                <span className="text-[12px] text-[#6c868e]">30 DAYS</span>
                            </div>
                        </div>
                    </div>
                ...
                <div className="border px-4 py-3 font-ibm bg-white">
                    <div className="flex items-center gap-2">
                        ...
                        <div>
                            <span className="text-[14px] text-[#363a41]">Net Profit per Visit</span>
                            <div className="flex gap-3 items-center">
                                <span className="text-[#1d1d1b] text-[14px]">€0.00</span>
                                <span className="text-[12px] text-[#6c868e]">30 DAYS</span>
                            </div>
